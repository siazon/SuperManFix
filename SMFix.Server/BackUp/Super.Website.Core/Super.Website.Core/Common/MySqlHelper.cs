...
namespace Super.Website.Core
{
    ...
    {
        //连接用的字符串  
        private string connStr = @"server=121.196.195.252;database=shumafix;uid=root;pwd=chaoren;charset='utf8';SslMode=None";
        // private string connStr = "server=127.0.0.1;database=super;uid=root;pwd=root;charset='utf8';SslMode=None";
        ...
        {
          try{  using (MySqlConnection con = new MySqlConnection(ConnStr))
            {
