...
namespace superMan
{
    ...
    {
        //连接用的字符串  
        private string connStr = ConfigurationManager.ConnectionStrings["myconn"].ConnectionString;
        ...
        public DataSet ExecuteDataSet(string sql, params MySqlParameter[] paras)
        {
            ...
            {
               // Log.WriteError("mysql>>ExecuteDataSet" + sql, ex);
                return new DataSet();
            }
        ...
        public DataTable ExcuteDataTable(string sql, params MySqlParameter[] paras)
        {
            ...
            {
               // Log.WriteError("mysql>>ExcuteDataTable" + sql, ex);
        ...
        public object ExecuteScalar(string SQLString, params MySqlParameter[] paras)
        {
            ...
            {
                //Log.WriteError("mysql>>SQLString" + SQLString, ex);
                return "0";
            }
        }
        ...
        public int ExecuteNonquery(string sql, params MySqlParameter[] paras)
        {
            ...
            {
                //Log.WriteError("mysql>>ExecuteNonquery" + sql, ex);
                return 0;
            }
        }
        ...
        public int ExecuteProcNonQuery(string procname, params MySqlParameter[] paras)
        {
            ...
            {
                //Log.WriteError("mysql>>ExecuteProcNonQuery"+ procname, ex);
                return 0;
            }
        }

        public MySqlParameter[] ExecuteProcByRetrun(string procname,  MySqlParameter[] outParas, params MySqlParameter[] paras)
         {
            try
            {
                using (MySqlConnection con = new MySqlConnection(ConnStr))
                {
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddRange(paras);
                    cmd.Parameters.AddRange(outParas);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    return outParas;
                }
            ...
            {
                //Log.WriteError("mysql>>ExecuteProcByRetrun" + procname, ex);
                return null;
            }
        }
        /// <summary>  
        ...
        public DataTable ExecuteProcQuery(string procname, params MySqlParameter[] paras)
        {
            ...
            {
                //Log.WriteError("mysql>>ExecuteProcQuery" + procname, ex);
                return new DataTable();
            }
        }
        ...
        public bool ExcuteCommandByTran(params MySqlCommand[] cmds)
        {
            ...
            {
                //Log.WriteError("mysql>>ExcuteCommandByTran", ex);
                return false;
            }
        }
        ...
        public DataTable ExcuteDataWithPage(string sql, ref int totalCount, params MySqlParameter[] paras)
        {
            ...
            {
                //Log.WriteError("mysql>>ExcuteDataWithPage" + sql, ex);
                return new DataTable();
            }
        }
